        ...
        <div id="${address.id}" class="panel-collapse collapse">
            <div class="panel-body">
                <div class="col-md-6">
                    ...
                    <a href="#" id="btn-update-address${address.id}" value="${address.id}"
                       class="welcome-button-2 hvr-shutter-in-horizontal-2 btn-update-address top-10">Update
                    </a>
                    </div>
                </div>
            </div>
    ...
    <div id="newAddress" class="panel-collapse collapse">
        <div class="panel-body">
            <div class="col-md-6">
                ...
                <a href="#" id="btn-save-address" value="${address.id}"
                   class="welcome-button-2 hvr-shutter-in-horizontal-2 col-lg-1 top-10">Save
                </a>
            </div>
        </div>
    </div>
