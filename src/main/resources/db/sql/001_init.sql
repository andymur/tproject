...
ALTER TABLE "customer" ADD CONSTRAINT "customer_fk0" FOREIGN KEY ("role_id") REFERENCES "role"("id");
ALTER TABLE "customer" ADD CONSTRAINT "customer_fk1" FOREIGN KEY ("basket_id") REFERENCES "basket_product"("id");

ALTER TABLE "address" ADD CONSTRAINT "address_fk0" FOREIGN KEY ("customer_id") REFERENCES "customer"("id");

ALTER TABLE "order" ADD CONSTRAINT "order_fk0" FOREIGN KEY ("delivery_address_id") REFERENCES "address"("id");
ALTER TABLE "order" ADD CONSTRAINT "order_fk1" FOREIGN KEY ("order_status_id") REFERENCES "order_status"("id");
ALTER TABLE "order" ADD CONSTRAINT "order_fk2" FOREIGN KEY ("delivery_type_id") REFERENCES "delivery_type"("id");
ALTER TABLE "order" ADD CONSTRAINT "order_fk3" FOREIGN KEY ("payment_type_id") REFERENCES "payment_type"("id");
