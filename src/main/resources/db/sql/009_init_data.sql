...
INSERT INTO ADDRESS (user_id,country,city, street, building,appartment,zip_code,email,phone_number)
VALUES((select u.id from app_user u where u.role_id=2),'Russia', 'Saint-Petersburg','Savushkina str.' , '35','Linus Shop', 198504, 'alex.pench@gmail.com', '89118399061');
